...
> Full margin analysis and cost breakdown: see `PRICING.md`

This product is priced as a **work execution platform**, not a knowledge base.
Every AI output (email, job description, Slack message, policy summary) saves an employee 20–60 minutes.
Plans are limited by **AI task outputs/month** — the primary unit of value delivered.

---

### Plan 1 — Starter — $59/month

**Who it's for:** Small teams of 5–15 people. A founder or ops lead who wants the whole company on the same page.

| | Monthly | Quarterly | Annual |
|---|---|---|---|
| **Price** | **$59/month** | **$159/quarter** *(save $18, ~10% off)* | **$564/year** *(save $144, ~20% off)* |

**Included:**
- Up to **10 users**
- **200 documents** (50 MB max per file)
- **500 AI task outputs/month** — emails, JDs, Slack messages, summaries, answers
...
### Plan 2 — Growth — $149/month

**Who it's for:** Growing teams of 15–50 people where multiple departments are using the brain daily.

| | Monthly | Quarterly | Annual |
|---|---|---|---|
| **Price** | **$149/month** | **$402/quarter** *(save $45, ~10% off)* | **$1,428/year** *(save $360, ~20% off)* |

**Included:**
- Up to **40 users**
- **1,000 documents** (100 MB max per file)
- **2,500 AI task outputs/month**
- All file types (PDF, DOCX, TXT, MD + future types)
- Unlimited conversation history
- Task output analytics (what's being generated most)
- Priority email support (24h response)
- 1 workspace

---

### Plan 3 — Business — $349/month

**Who it's for:** Companies 50+ people where Company Brain is a core daily work tool across every team.

| | Monthly | Quarterly | Annual |
|---|---|---|---|
| **Price** | **$349/month** | **$942/quarter** *(save $105, ~10% off)* | **$3,348/year** *(save $540, ~13% off)* |

**Included:**
- **Unlimited users**
- **Unlimited documents**
- **Unlimited AI task outputs**
- All file types
- Unlimited conversation history
- Full usage analytics + per-user activity
- Dedicated onboarding call (1 hour)
- Slack/email support with 24h SLA
- 99.9% uptime SLA
- Up to 3 workspaces (departments)
...
```
Paid infra cost at 10+ customers:  ~$100/month fixed + LLM variable

1 × Growth plan ($149)  = covers fixed infra entirely
2 × Growth plan ($298)  = profitable even after LLM costs
1 × Business plan ($349) = profitable from day one

Target for Month 1: 1 Growth customer. That's it.
```
