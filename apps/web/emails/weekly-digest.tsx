...
export function WeeklyDigestEmail(props: WeeklyDigestEmailProps) {
  ...
  return (
    ...
    >
      <Text style={p}>Here&apos;s how Company Brain worked for your team this week.</Text>
      ...
      {top_gap_topics.length > 0 && (
        <Section style={callout}>
          <Text style={calloutHeading}>Topics your team asked but Company Brain couldn&apos;t answer</Text>
      ...
      {top_intents.length > 0 && (
        <Text style={muted}>
          What they used Company Brain for:{" "}
          {top_intents
