...
export function WelcomeEmail({ first_name, org_name, app_url }: WelcomeEmailProps) {
  return (
    <EmailShell
      preview={`Welcome to Contexo, ${first_name ?? "there"}`}
    ...
    >
      ...
      <Text style={p}>
        Contexo works best when you give it real context — handbooks,
...
export const welcomeSubject = (props: WelcomeEmailProps): string =>
  `Welcome to Contexo${props.first_name ? `, ${props.first_name}` : ""}`;
