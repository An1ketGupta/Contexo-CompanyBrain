...
// Actual buttons are fully-rounded pills with generous horizontal padding.
// The primary action is always a near-black "ink" pill; blue is reserved for
// links and inline emphasis (the `link` variant), never a filled button.
