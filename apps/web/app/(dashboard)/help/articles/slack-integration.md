...
**Mention** — `@Nirnaya IQ` in a thread will reply in-thread, so context stays with the conversation.
...
- **"This app isn't installed in this channel"** — invite the bot first with `/invite @Nirnaya IQ`.
