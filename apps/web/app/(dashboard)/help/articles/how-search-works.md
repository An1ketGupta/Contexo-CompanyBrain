...
When you ask Company Brain a question, it doesn't pre-read everything you've uploaded. Instead, the model **decides what to look up** and we run a focused search across your documents for each lookup.
