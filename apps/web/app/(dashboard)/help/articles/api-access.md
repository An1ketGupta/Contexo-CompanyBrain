...
The Company Brain API lets you query your knowledge base and ingest documents from any system that can speak HTTP. It's available on Team and Business plans.
