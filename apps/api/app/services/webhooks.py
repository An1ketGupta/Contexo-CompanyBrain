...
ALLOWED_EVENTS: tuple[str, ...] = (
    ...
    "agent.completed",
    "agent.failed",
    # Workflow events — fired from approvals.py / compliance.py.
    # See module docstring for payload shapes.
    "approval.requested",
    "approval.decided",
    ...
    "output.failed",
    # ─ Agent2 Day 1 ───────────────────────────────────────────────────────
    # Emitted when a document row is first inserted (before ingest finishes).
